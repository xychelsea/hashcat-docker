...
LABEL description="Hashcat Vanilla Container"

# $ docker build --network=host -t xychelsea/hashcat:latest -f Dockerfile .
# $ docker run --rm -it xychelsea/hashcat:latest /bin/bash
# $ docker push xychelsea/hashcat:latest
...
# Install hashcat
RUN conda create -c conda-forge -n hashcat \
